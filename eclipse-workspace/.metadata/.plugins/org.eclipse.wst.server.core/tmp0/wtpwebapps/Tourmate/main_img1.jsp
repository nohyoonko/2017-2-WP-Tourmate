...
<body>
   ...
   <div class="mainbox">
   <p><h2 class="hotel_title">포시즌스 호텔 서울 <small>Four Seasons Hotel Seoul</small></h2></p>
   </div>
   ...
   <div class="imgbox">
      <img id="bgimg" src="main/포시즌스 호텔 서울.jpg">
   </div>
   <form>
   <div class="whitebox">
      <div class="input">
      <br>
      <b><font size=3 color="black">가격 (1박 기준)</font></b><br>
