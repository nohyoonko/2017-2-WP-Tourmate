...
<body>
   ...
   <div class="mainbox">
   <p><h2 class="hotel_title">[LOT 폴란드 항공] 한국 취항 1주년 특가 판매 <small>폴란드, 바르샤바, 오슬로</small></h2></p>
   </div>
   ...
   <div class="imgbox">
      <img id="bgimg" src="main/폴란드 항공.jpg">
   </div>
   <form>
   <div class="whitebox">
      <div class="input">
      ...
      <b><font size=3 color="black">가격 (왕복 기준)</font></b><br>
       최저 <font color="red" size="5"><b>724,400</b></font>원
      </div>
