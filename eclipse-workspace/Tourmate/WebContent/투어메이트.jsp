...
<body>
   <!-- 제목+메뉴바를 포함한 Header.jsp 파일을 include -->
    ...
    <br><br>
    <div id="best2" onclick="location.href='main_img7.jsp'">
    ...
    <div id="best2" onclick="location.href='main_img8.jsp'">
    ...
    <br>
    <div id="best3" onclick="location.href='main_img9.jsp'">
        <img id="box5" src="main/돈키호테.png">
        <div id="best_korname"> 일본 돈키호테 할인쿠폰 </div>
    </div>
    <div id="best3" onclick="location.href='main_img10.jsp'">
